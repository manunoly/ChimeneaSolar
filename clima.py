...
class ClimaPropiedades:
    ...
    def __init__(self, fichero = '/home/manuel/PycharmProjects/chimeneaSolar/climaTena15-16-17Oct.csv', posTamb = 1, posRad = 2, posVelV = 3, posRH = 0, inicio = 1, fin = 72, lineasUtilizar= None, delimitador=','):
        try:
            data = open(fichero,'r')
